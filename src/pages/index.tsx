  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Geometry Dash Platform - Where normal meets fun in a game that challenges your agility and creativity!"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Geometry Dash Platform - Where normal meets fun in a game that challenges your agility and creativity!`}
            </Text>
            <Box
